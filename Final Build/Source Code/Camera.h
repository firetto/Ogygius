...
Contains the class definitions and functions of the camera class, which is a child class of sf::View
*/
...
// check whether rectangle is in the view of the camera
bool Camera::inView(sf::FloatRect obj) {
	// creates a rectangle to be the camera boundary
